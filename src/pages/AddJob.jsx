  ...
  return (
    <>
      ...
      <div className="horizontal_flex fivepx_margin">
        ...
        <TextField
          id="outlined-basic"
          label="desired domain experience"
          name="desiredDomainExp"
          variant="outlined"
          value={job.desiredDomainExp}
          onChange={handleChange}
          sx={{
            margin: '0px 4px',
          }}
      ...
      <div className="horizontal_flex fivepx_margin">
        ...
        <TextField
          id="outlined-basic"
          label="desired product experience"
          name="desiredExpProduct"
          variant="outlined"
          value={job.desiredExpProduct}
          onChange={handleChange}
          sx={{
            margin: '0px 4px',
          }}
      ...
      <div className="fivepx_margin">
        ...
        <Button variant="contained" onClick={goBackToHome}>
          Cancel
        </Button>
      </div>
    </>
